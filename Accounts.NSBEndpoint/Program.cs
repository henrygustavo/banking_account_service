...
using Accounts.Infrastructure.Mappings;
...
namespace Accounts.NSBEndpoint
{
    class Program
    {
        static async Task Main()
        {
            ...
            var endPointName = "Accounts.NSBEndpoint";
            ...
            string mysqlConnectionString = Environment.GetEnvironmentVariable("MYSQL_STRCON_CORE_ACCOUNTS");
        ...
        static Configuration AddFluentMappings(Configuration nhConfiguration, string connectionString)
        {
            return Fluently
                ...
                .Mappings(cfg =>
                {
                    cfg.FluentMappings.AddFromAssembly(typeof(AccountMap).Assembly);
